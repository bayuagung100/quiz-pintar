...
<script src="<?php echo url("website/dashboard/");?>plugins/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js">
</script>
<!-- InputMask -->
...
<script src="<?php echo url("website/dashboard/");?>plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js">
</script>
<!-- Bootstrap Switch -->
...
<script
    src="<?php echo url("website/dashboard/");?>plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
</script>
<!-- fMCE  -->
...
<!-- overlayScrollbars -->
<script src="<?php echo url("website/dashboard/");?>plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js">
</script>
<!-- AdminLTE App -->
...
$('#kabupaten').change(function() {
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $set['
        url ']; ?>ajax/admin/cek-kecamatan.php',
        data: {
            'city_id': city_id
        },
